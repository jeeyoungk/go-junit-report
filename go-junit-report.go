...
func init() {
	...
	flag.BoolVar(&fullPackage, "full-package", false, "if true, output full package name")
}
...
func main() {
	...
	// Write xml
	err = formatter.JUnitReportXML(report, noXMLHeader, fullPackage, goVersionFlag, os.Stdout)
	if err != nil {
